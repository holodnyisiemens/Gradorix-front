...
import { Home, Calendar, Zap, Bell, Users, Link2, User } from 'lucide-react';
  ...
  switch (role) {
    case 'JUNIOR':
      return [
        ...
        { to: '/calendar',      icon: <Calendar size={20} />, label: 'Кален.' },
        { to: '/challenges',    icon: <Zap size={20} />,      label: 'Задачи' },
        { to: '/notifications', icon: <Bell size={20} />,     label: 'Уведы', badge: unreadCount },
